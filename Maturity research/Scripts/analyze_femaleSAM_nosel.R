...
t_occ <- read.csv("./Maturity research/Data/BT_occupied_females_nosel.csv") %>%
...
write.csv(fem.model.dat, "./Maturity research/Output/SNOW_female_modeldata_nosel.csv")
...
saveRDS(mod, "./Maturity research/Models/SNOW_femaleSAM_gamm_nosel.rda")
...
saveRDS(mod3, "./Maturity research/Models/SNOW_femalepmat5565_gam_nosel.rda")
